...
@Test (priority=6)
    private void checkIn() throws AWTException {
...
@Test(priority=7) 
    private void roomBooking() throws AWTException {
...
@Test(priority=8)
		private void payment() throws AWTException {
	    ...
	    driver.findElement(By.name("cc_type")).click();
	     ...
	     for (int i = 0; i <4; i++) {
	        ...
	        //To get  the order id
	        WebElement orderId = driver.findElement(By.name("order_id_853638"));
